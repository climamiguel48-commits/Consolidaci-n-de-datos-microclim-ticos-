...
Para el proyecto de investigación sobre determinación del consumo hídrico de
plantas ornamentales se instaló una estación meteorológica automática
compacta. Esta estación registra variables meteorológicas cada 30
minutos, estas son; temperatura, humedad relativa, velocidad del viento,
dirección del viento, presión atmosférica, radiación global y
precipitación.

Por cuestiones de seguridad, los datos se descargan semanalmente y estos se van almacenado en 
